...
s = Solver()
test_str = String('tst')
# s.add(Intersect(iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole2/testrolesession"),
#                                 iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole1/*")) == Empty(ReSort(StringSort())))
...
s.add(InRe(test_str, Intersect(iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole2/testrolesession"), iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole1/*"))))
# print(iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole2/testrolesession"))
# print(iam_pattern_to_regex("arn:aws:sts::218925562655:assumed-role/testrole1/*"))
